 ...
 *
 * Shared by the sitemap generator and the test suite. Project detail pages are
 * included explicitly rather than globbed, so a route cannot drift into the
 * sitemap before it exists.
 */
